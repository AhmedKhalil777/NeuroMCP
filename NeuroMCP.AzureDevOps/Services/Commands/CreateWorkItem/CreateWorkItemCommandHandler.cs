...
namespace NeuroMCP.AzureDevOps.Services.Commands.CreateWorkItem;

/// <summary>
/// Handler for creating a work item
/// </summary>
public class CreateWorkItemCommandHandler : AzureDevOpsRequestHandler<CreateWorkItemCommand, CreateWorkItemCommandResult>
{
    ...
    /// </summary>
    public override async Task<CreateWorkItemCommandResult> Handle(CreateWorkItemCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            return new CreateWorkItemCommandResult
            {
